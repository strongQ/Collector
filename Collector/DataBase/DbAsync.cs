...
{
    public abstract partial class DBAsync
    {
        ...
        //{
        //    var rows = 
        //        await QueryAsync<T>(sql.ToString(), p);
        //    var total = rows.Count();
        //    if (string.IsNullOrWhiteSpace(sqlTotal)) { total = await ExecuteScalarAsync<int>(sqlTotal, p2); }
